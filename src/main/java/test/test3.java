...
public class test3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\tCA_UDP_EnergyConsumption\tCU_UDP_EnergyConsumption\tCU_BFD_EnergyConsumption\tCA_UDP_f\tCU_BFD_f\tCU_UDP_f");
        for (Ub = 0.5; Ub < 0.91; Ub += 0.05){
            ...
            for (int i = 0; i < 100; i++){
                ...
                if (f_CU_UDP==1 &&f_CA_UDP==1 && f_CU_BFD==1){
            ...
            System.out.println("\t"+CA_UDP_Energy / count + "\t" + CU_UDP_Energy / count + "\t"+CU_BFD_Energy / count + "\t"+CA_UDP_Feasibility / 100.0+"\t"+CU_BFD_Feasibility / 100.0+"\t"+CU_UDP_Feasibility / 100.0+"\t");
        }
