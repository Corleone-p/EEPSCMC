...
public class testOfU {
    public static void main(String[] args) {
        ...
        M = 4;
        double Ub;
//        System.out.print("CA_FFD_Feasibility\tCA_BFD_Feasibility\tCA_WFD_Feasibility\tCA_NFD_Feasibility\tCU_WFD_Feasibility" +
//                "\tCA_FFD_EnergyConsumption\tCA_BFD_EnergyConsumption\tCA_WFD_EnergyConsumption\tCA_NFD_EnergyConsumption");
        ...
        for (Ub = 0.5; Ub < 0.91; Ub += 0.05) {
            ...
            for (int i = 0; i < 100; i++) {
                ...
                Utilization.utilization_Scaling(Ub * M, Task_HI, Task_LO);//放缩有问腿
                ...
                if (CA_FFD.CA_FFD_Partitioning(Task_HI, Task_LO, M_List_CA_FFD) == 1) {//边分配边判断
                    CA_FFD_Feasibility++;
...
//            System.out.print(nf.format(CA_FFD_Feasibility / 10000.0) + "\t" + nf.format(CA_BFD_Feasibility / 10000.0) + "\t" + nf.format(CA_WFD_Feasibility / 10000.0) + "\t" + nf.format(CA_NFD_Feasibility / 10000.0) + "\t" + nf.format(CU_WFD_Feasibility / 10000.0) + "\t" +
