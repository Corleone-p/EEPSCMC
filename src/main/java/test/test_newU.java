...
//            System.out.println(nf.format(CA_BFD_FFD_F / t) + "\t" + nf.format(CA_BFD_NFD_F / t) + "\t" + nf.format(CA_BFD_WFD_F / t) + "\t" + nf.format(CA_FFD_BFD_F / t) + "\t" + nf.format(CA_FFD_NFD_F / t) +
//                    "\t" + nf.format(CA_FFD_WFD_F / t) + "\t" + nf.format(CA_NFD_BFD_F / t) + "\t" + nf.format(CA_NFD_FFD_F / t) + "\t" + nf.format(CA_NFD_WFD_F / t) + "\t" +nf.format(CA_WFD_BFD_F / t) + "\t"
//                    +nf.format(CA_WFD_FFD_F / t) +"\t" +nf.format(CA_WFD_NFD_F / t)+"\t" +nf.format(CA_WFD_F / t)+"\t" +nf.format(CU_WFD_F / t));
